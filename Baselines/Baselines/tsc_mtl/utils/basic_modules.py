...
from tensorflow.keras.layers import Dense, Conv1D, Conv2D, Conv3D, TimeDistributed, AveragePooling1D, GlobalAveragePooling1D, GlobalAveragePooling2D, GlobalMaxPooling2D, GlobalMaxPooling1D
